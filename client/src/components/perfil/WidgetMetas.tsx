  ...
  return (
    <div className="w-full bg-white rounded-xl border border-gray-300 p-4 flex flex-col relative">
            ...
            <div key={idx} className="border border-gray-400 rounded-xl p-4 flex items-center gap-4 bg-white">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-red-500 text-xl">
                    <svg width="22" height="22" fill="none" viewBox="0 0 24 24"><path d="M12 19V5M12 5l-5 5M12 5l5 5" stroke="red" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
                  </span>
                </div>
              ...
              <div className="flex flex-col items-end justify-between h-full min-w-[160px]">
                <button className="bg-purple-200 hover:bg-purple-300 text-purple-700 rounded-full p-2 mb-2">
                  <FaEdit onClick={() => setEditModalIsOpen(true)}/>
                </button>
                <EditGoalModal
                    isOpen={editModalIsOpen}
                    onClose={() => setModalIsOpen(false)}
                    goalName={meta.goal.goal_name}
                    goalId={meta.goal_id}
      ...
      <div className="flex items-center justify-between mt-8">
        ...
        <button className="ml-auto hover:text-bold  rounded-xl px-8 py-3 text-lg font-semibold  hover:text-primary flex items-center gap-2 cursor-pointer">
