  ...
  return (
    <>
      ...
      <div className="relative w-full h-screen overflow-hidden bg-base-200 font-sans">
        ...
        <div
          className={`absolute top-0 left-0 w-[100vw] h-[200vh] bg-cover bg-center transition-transform duration-700 ease-in-out ${
            activeSection === "top" ? "translate-y-0" : "-translate-y-1/2"
          }`}
        ...
        >
          ...
          <div className="absolute top-0 w-full h-screen flex items-center justify-center pb-15">
            <div className="text-center font-[Kantumruy Pro]">
              ...
              <p
                className="text-7xl font-light mb-4 pr-40"
                style={{ fontFamily: "'Kantumruy Pro', sans-serif" }}
              >
                Explorer
              </p>
