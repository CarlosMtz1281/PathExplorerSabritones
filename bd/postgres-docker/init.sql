...
('Certified ScrumMaster', 'Scrum master certification', 'Scrum Alliance'),
...
('Certified Kubernetes Administrator', 'Kubernetes administration certification', 'Linux Foundation'),
('TOGAF 9 Certified', 'Enterprise architecture certification', 'The Open Group'),
('ISTQB Certified Tester', 'Software testing certification', 'ISTQB'),
('CISSP', 'Information security certification', 'ISC2'),
('Salesforce Certified Administrator', 'Salesforce administration certification', 'Salesforce'),
('Red Hat Certified Engineer', 'Linux system administration certification', 'Red Hat');
