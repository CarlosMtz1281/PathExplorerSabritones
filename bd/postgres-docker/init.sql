...
(14, 'E-Learning Platform', 'EduTech Solutions', 'Development of an interactive e-learning platform', '2025-06-01', '2026-03-31', 7),
(14, 'Smart Home Automation', 'HomeTech Inc.', 'IoT-based smart home automation system', '2025-07-01', '2026-04-30', 7),
(14, 'Retail Analytics Dashboard', 'Retail Insights', 'Dashboard for retail data analytics and visualization', '2025-08-01', '2026-05-31', 7),
(14, 'AI-Powered CRM', 'CustomerFirst', 'AI-driven customer relationship management system', '2025-09-01', '2026-06-30', 7),
(14, 'Blockchain Voting System', 'SecureVote', 'Blockchain-based secure voting platform', '2025-10-01', '2026-07-31', 7),
(14, 'Healthcare Mobile App', 'HealthTech', 'Mobile app for healthcare appointment scheduling and tracking', '2025-11-01', '2026-08-31', 7),
(14, 'Logistics Optimization Tool', 'LogiTech', 'Tool for optimizing logistics and supply chain operations', '2025-12-01', '2026-09-30', 7),
(14, 'Energy Management System', 'GreenEnergy', 'Platform for monitoring and managing energy consumption', '2026-01-01', '2026-10-31', 7),
(14, 'Social Media Analytics', 'SocialMetrics', 'Analytics platform for social media performance tracking', '2026-02-01', '2026-11-30', 7),
(14, 'E-Commerce Recommendation Engine', 'ShopSmart', 'AI-powered recommendation engine for e-commerce platforms', '2026-03-01', '2026-12-31', 7),
(14, 'Virtual Reality Training', 'VRLearn', 'VR-based training platform for corporate learning', '2026-04-01', '2027-01-31', 7),
(14, 'Cybersecurity Threat Detection', 'SecureNet', 'AI-driven threat detection system for cybersecurity', '2026-05-01', '2027-02-28', 7),
(14, 'Personal Finance Manager', 'FinanceBuddy', 'Mobile app for personal finance tracking and budgeting', '2026-06-01', '2027-03-31', 7),
(14, 'Smart City Dashboard', 'UrbanTech', 'Dashboard for monitoring and managing smart city infrastructure', '2026-07-01', '2027-04-30', 7),
(14, 'Online Marketplace', 'MarketPlacePro', 'Development of an online marketplace platform', '2026-08-01', '2027-05-31', 7),
(14, 'AI Legal Assistant', 'LegalAI', 'AI-powered assistant for legal research and document drafting', '2026-09-01', '2027-06-30', 7),
(14, 'Fitness Tracking App', 'FitLife', 'Mobile app for fitness tracking and health monitoring', '2026-10-01', '2027-07-31', 7),
(14, 'Remote Work Collaboration Tool', 'TeamSync', 'Platform for remote team collaboration and communication', '2026-11-01', '2027-08-31', 7),
(14, 'Digital Payment Gateway', 'PaySecure', 'Secure and scalable digital payment gateway', '2026-12-01', '2027-09-30', 7),
